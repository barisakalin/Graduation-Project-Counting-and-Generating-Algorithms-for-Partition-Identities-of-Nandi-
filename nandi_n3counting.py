# -*- coding: utf-8 -*-
"""nandi_n3counting.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1yfo6cNbkY-9eiDs1LZ0FD89fUZ13rSTn
"""
...
def E(n,m):
  ...
  while a <= n and m-n3_index >= 0:
    sub += C(n-a-(m-n3_index)*(4+n3_index2),m-n3_index,4)
    a += b
    b += 2
    n3_index += 1
    n3_index2 += 2

  return C(n-m*2,m,0) + C(n-2-(m-1)*2,m-1,2) - sub
