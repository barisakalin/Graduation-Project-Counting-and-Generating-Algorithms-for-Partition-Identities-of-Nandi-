# -*- coding: utf-8 -*-
"""nandi_n2generating.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1lKpQlpZgyopuJm-9OKi5H8vB4Iu_Mshm
"""
...
n1_partitions[2][4].append([3,1])
n1_partitions_bool[2][4].append([True])
...
for i in range(1,m):
  for j in range(min_array[i],n+1):
    for x in range(0,len(n1_partitions[i][j])):
      ...
      while curr_num + j <= n:
        #print(i,j,curr_num)
        if curr_num == 1 or curr_num == 2 or curr_num == 3:
          curr_num += 1
          continue
